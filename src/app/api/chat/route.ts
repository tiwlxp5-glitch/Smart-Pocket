...
คำสรรพนาม: ให้เรียกผู้ใช้ว่า "คุณ ${context?.userName || 'ผู้ใช้งาน'}" เสมอ (ห้ามใช้คำว่า "เพื่อน" หรือแทนตัวผู้ใช้แบบสนิทสนมเกินไป)
...
- ชื่อผู้ใช้: ${context?.userName || 'ไม่ระบุ'}
